          ...
          <div className="container">
            ...
            >
              ...
              >
                ...
                leaders of tomorrow. With an interdisicplinary focus, we aspire
          ...
          <div className="container" style={{ marginTop: 30 }}>
            <div className="justify-content-center">
              ...
              <p style={{ textAlign: "center" }}>
                Designed with core sectors in mind, Circle integrates science,
                technology, business, and social science to bring solutions to
            ...
            >
              <div className="col-lg-4">
                <CSectors
                  img="https://hellocircle.ca/assets/business.png"
                  title="Business"
                ></CSectors>
              </div>
              <div className="col-lg-4">
                <CSectors
                  img="https://hellocircle.ca/assets/tech.png"
                  title="Technology"
                ></CSectors>
              </div>
            </div>
            ...
            >
              <div className="col-lg-4">
                <CSectors
                  img="https://hellocircle.ca/assets/socialsci.png"
                  title="Social Science"
                ></CSectors>
              </div>
              <div className="col-lg-4">
                <CSectors
                  img="https://hellocircle.ca/assets/science.png"
                  title="Science"
                ></CSectors>
              </div>
            </div>
        ...
        <div style={{ backgroundColor: "white", marginTop: 50 }}>
          <div className="container">
            ...
            <div className="row" style={{ marginTop: 20 }}>
              <div className="col-lg-8">
                <p style={{ color: "black" }}>
                  Our love for innovation allows us to bring you experiences
                  like never before. Whether it is our flagship ideation
                  conferences to networking sessions with industry leaders, the
                  Circle experience is....BLAH BLAH BLAH.
                </p>
              </div>
            </div>
            <div
            ...
            >
              ...
              <div className="col-lg-8">
                ...
                <p>
                  Students from 17 universities across North America came
                  together virtually and created innovative solutions to the
                  most pressing issues of the education system.
                </p>
              </div>
            </div>
          </div>
